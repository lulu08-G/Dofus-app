...
# ========================
        ...
        # Vérifier si Streamlit fonctionne correctement
    st.title("Test de Streamlit")
    
    # Ajouter un simple bouton pour tester si l'application répond
    if st.button("Test de réponse"):
        st.write("Le bouton fonctionne !")
    
    # Simple message pour tester le rendu
    st.write("🔄 Application Streamlit est lancée.")
